    ...
    <div class="container">
      ...
      <template v-if="tickers.length">
        <div>
          ...
          <button
            class="m-2 my-4 inline-flex items-center py-2 px-4 border border-transparent shadow-sm text-sm leading-4 font-medium rounded-full text-white bg-gray-600 hover:bg-gray-700 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
          >
            Назад
          </button>
          <button
...
export default {
  ...
  methods: {
    ...
    subscribeToUpdates(tickerName) {
      setInterval(async () => {
        const f = await fetch(
          `https://min-api.cryptocompare.com/data/price?fsym=${tickerName}&tsyms=USD&api_key=e928439f0c76ad4a263956d6f213e9966f2fa8d47e73d43414b303ffbcf9542b`
        );
